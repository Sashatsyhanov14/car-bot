...
const translations: any = {
  ru: {
    ...
    statsNewRequests: "Новых заявок",
    refAnalytics: "Реферальная аналитика и выплаты",
    refBalance: "баланс",
    refInvited: "Привёл",
    refRequests: "Заявок",
    refConversion: "Конверсия",
    refRevenue: "Выручка",
    refPaid: "Выплачено",
    refPayoutBtn: "Выплатить",
    refOrders: "Заявки",
    refInvitedUsers: "Приглашённые",
    refHistory: "История выплат",
    recentRequests: "Последние заявки",
    refresh: "Обновить",
    noRequests: "Заявок нет",
    statusContacted: "Связался",
    statusDone: "Готово",
    viewCars: "Машины",
    viewTransfers: "Трансферы",
    addItem: "Добавить",
    editItem: "Изменить",
    brand: "Марка",
    model: "Модель",
    ...
    addNewCar: "Новое Авто",
    addNewTransfer: "Новый Трансфер",
    deleteConfirm: "Вы уверены?",
    linkCopied: "Скопировано!",
    editExcursion: "Изменить экскурсию",
    newExcursion: "Новая экскурсия",
  ...
  en: {
    ...
    statsNewRequests: "New requests",
    refAnalytics: "Referral Analytics & Payouts",
    refBalance: "balance",
    refInvited: "Invited",
    refRequests: "Requests",
    refConversion: "Conv.",
    refRevenue: "Rev.",
    refPaid: "Paid",
    refPayoutBtn: "Payout",
    refOrders: "Orders",
    refInvitedUsers: "Invitees",
    refHistory: "Payout History",
    ...
    addNewCar: "New Car",
    addNewTransfer: "New Transfer",
    deleteConfirm: "Are you sure?",
    linkCopied: "Copied!",
    editExcursion: "Edit Excursion",
    ...
    managerRemoveSuccess: "Staff {id} removed.",
  ...
  tr: {
    ...
    statsNewRequests: "Yeni başvurular",
    refAnalytics: "Referans Analitiği ve Ödemeler",
    refBalance: "bakiye",
    refInvited: "Davet",
    refRequests: "Talep",
    refConversion: "Dönüşüm",
    refRevenue: "Gelir",
    refPaid: "Ödenen",
    refPayoutBtn: "Ödeme yap",
    refOrders: "Siparişler",
    refInvitedUsers: "Davet Edilenler",
    refHistory: "Ödeme Geçmişi",
    recentRequests: "Son Başvurular",
    refresh: "Yenile",
    noRequests: "Başvuru yok",
    statusContacted: "Temas kurudulu",
    statusDone: "Tamamlandı",
    viewCars: "Arabalar",
    viewTransfers: "Transferler",
    addItem: "Ekle",
    editItem: "Düzenle",
    brand: "Marka",
    model: "Model",
    ...
    saveCar: "Arabayı Kaydet",
    saveRoute: "Rotayı Kaydet",
    addNewCar: "Yeni Araba",
    addNewTransfer: "Yeni Transfer",
    deleteConfirm: "Emin misiniz?",
    linkCopied: "Kopyalandı!",
    editExcursion: "Geziyi Düzenle",
    newExcursion: "Yeni Gezi",
    photoGallery: "Fotoğraf Galerisi",
    aiTranslate: "AI Çeviri",
    allExcursions: "Tüm Geziler",
    client: "Müşteri",
    details: "Detaylar",
    passengers: "Yolcular",
    ocean: "Okyanus",
  ...
  fa: {
    ...
    viewCars: "خودروها",
    viewTransfers: "ترانسفرها",
    addItem: "افزودن",
    editItem: "ویرایش",
    brand: "برند",
    model: "مدل",
    city: "شهر",
    pricePerDay: "قیمت / روز",
    description: "توضیحات",
    fromLocation: "از",
    toLocation: "به",
    price: "قیمت ($)",
